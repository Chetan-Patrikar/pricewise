import { c as createLucideIcon, o as commonjsGlobal, p as getDefaultExportFromCjs, r as reactExports, q as clsx, R as React, s as invariant, t as useParams, v as useWishlist, m as useComparison, j as jsxRuntimeExports, L as Link, B as Badge, a as Button, H as Heart, C as ChartColumn } from "./index-B4L6VRFV.js";
import { c as useProduct, u as useProducts, S as Skeleton } from "./useProducts-Dd6Y_mVu.js";
import { S as SAMPLE_PRODUCTS, E as ExternalLink, C as Check, b as PLATFORM_ICONS, P as PLATFORM_COLORS } from "./index-J61HW4zR.js";
...
function getBestDeal(platforms) {
  const inStock = platforms.filter((p2) => p2.inStock);
  if (inStock.length === 0) return platforms[0] ?? null;
  return inStock.reduce(
    (best, p2) => p2.price < best.price ? p2 : best,
    inStock[0]
  );
}
function RatingStars({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: [1, 2, 3, 4, 5].map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Star,
    {
      className: `${cls} ${s2 <= Math.floor(rating) ? "fill-amber-400 text-amber-400" : s2 - 0.5 <= rating ? "fill-amber-400/50 text-amber-400" : "text-muted-foreground/30"}`
    },
    s2
  )) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[3fr_2fr] gap-10 mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[480px] rounded-2xl" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-10" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-10" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-64 w-full rounded-2xl mb-12" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 overflow-hidden", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-56 shrink-0 rounded-xl" }, i)) })
      ]
    }
  );
}
function NotFoundState() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-2xl bg-muted flex items-center justify-center mb-5 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-10 h-10 text-muted-foreground" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6 max-w-sm", children: "This product doesn't exist or may have been removed. Browse our catalog to find great deals." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { "data-ocid": "product_detail.browse_button", children: [
...
function ProductDetailPage() {
  ...
  if (!product) return /* @__PURE__ */ jsxRuntimeExports.jsx(NotFoundState, {});
  const wishlisted = isInWishlist(product.id);
  const inComparison = isSelected(product.id);
  const bestDeal = getBestDeal(product.platforms);
  const maxDiscount = Math.max(...product.platforms.map((p2) => p2.discount));
  const minPrice = Math.min(
    ...product.platforms.filter((p2) => p2.inStock).map((p2) => p2.price)
  );
  const similarProducts = (allProducts ?? SAMPLE_PRODUCTS).filter((p2) => p2.category === product.category && p2.id !== product.id).slice(0, 6);
  const sortedPlatforms = [...product.platforms].sort(
    (a2, b2) => a2.price - b2.price
  );
  const priceMin = product.priceHistory ? Math.min(...product.priceHistory.map((p2) => p2.price)) : 0;
  const priceMax = product.priceHistory ? Math.max(...product.priceHistory.map((p2) => p2.price)) : 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", "data-ocid": "product_detail.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border-b border-border/50 px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto flex items-center gap-2 text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto px-4 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[3fr_2fr] gap-10 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              maxDiscount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-5 left-5 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent text-accent-foreground border-0 font-bold text-sm px-3 py-1 shadow-md", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-3.5 h-3.5 mr-1.5" }),
                "Up to ",
                maxDiscount,
                "% OFF"
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.img,
                {
                  ...
                  onError: (e3) => {
                    e3.target.src = "/assets/images/placeholder.svg";
                  }
                }
              )
            ]
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs font-semibold", children: product.category }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "outline",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl lg:text-3xl font-bold text-foreground leading-tight mb-2", children: product.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RatingStars, { rating: product.averageRating }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground", children: product.averageRating }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-5", children: product.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "flex flex-wrap gap-1.5 mb-6",
                  "data-ocid": "product_detail.tags",
                  children: product.tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-accent/40 bg-accent/8 p-5 mb-5 glass-dark", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-wide text-accent", children: "Best Price Available" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent text-accent-foreground border-0 text-xs font-bold", children: "🏆 Best Deal" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-4xl font-black text-accent mb-1", children: [
                  "$",
                  minPrice.toFixed(2)
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
                  "on",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: bestDeal == null ? void 0 : bestDeal.platform }),
                  bestDeal && bestDeal.originalPrice > bestDeal.price && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    " ",
                    "·",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("s", { className: "opacity-70", children: [
                      "$",
                      bestDeal.originalPrice.toFixed(2)
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1.5 text-accent font-semibold", children: [
                      "Save $",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      ...
                      "Buy at ",
                      bestDeal == null ? void 0 : bestDeal.platform,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    className: wishlisted ? "border-rose-400/60 text-rose-400 bg-rose-500/10 hover:bg-rose-500/20" : "hover:border-rose-400/40 hover:text-rose-400",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: inComparison ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "w-4 h-4" })
                  }
                )
              ] }),
              !inComparison && !canAdd && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2 text-center", children: "Max 4 products in comparison" })
            ]
          }
        )
      ] }),
        ...
        motion.section,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-xl font-bold text-foreground mb-5 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-6 bg-accent rounded-full inline-block" }),
              "Price Comparison Across Platforms"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl overflow-hidden border border-border/60 shadow-elevated", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-[2fr_1fr_1fr_1fr_1fr_auto] gap-0 px-5 py-3 border-b border-border/50 bg-muted/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground", children: "Platform" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground text-right", children: "Price" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground text-right hidden sm:block", children: "Original" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground text-center hidden sm:block", children: "Discount" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground text-center", children: "Stock" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-muted-foreground text-right", children: "Action" })
              ] }),
              sortedPlatforms.map((pp, idx) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    className: `grid grid-cols-[2fr_1fr_1fr_1fr_1fr_auto] gap-0 items-center px-5 py-4 border-b border-border/30 last:border-b-0 transition-smooth ${isBest ? "bg-accent/8 border-l-2 border-l-accent" : "hover:bg-muted/20"}`,
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: PLATFORM_ICONS[pp.platform]
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground text-sm truncate", children: pp.platform }),
                          isBest && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-accent text-accent-foreground border-0 text-[10px] font-bold px-1.5 leading-none shrink-0", children: "BEST PRICE" })
                        ] }) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                          className: `font-bold font-display text-base ${isBest ? "text-accent" : "text-foreground"}`,
                          children: [
                            "$",
                            pp.price.toFixed(2)
                          ]
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right hidden sm:block", children: pp.originalPrice > pp.price ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground line-through", children: [
                        "$",
                        pp.originalPrice.toFixed(2)
                      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "—" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center hidden sm:block", children: pp.discount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Badge,
                        {
                          variant: "outline",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: pp.inStock ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-emerald-500", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium hidden lg:inline", children: "In Stock" })
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium hidden lg:inline", children: "Out of Stock" })
                      ] }) }),
      ...
      product.priceHistory && product.priceHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          initial: { opacity: 0, y: 24 },
          whileInView: { opacity: 1, y: 0 },
      ...
      similarProducts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          initial: { opacity: 0, y: 24 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-xl font-bold text-foreground flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-6 bg-secondary-foreground/40 rounded-full inline-block" }),
                "Similar Products"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: similarProducts.map((sim, idx) => {
                  const simBest = getBestDeal(sim.platforms);
                  const simMaxDiscount = Math.max(
                    ...sim.platforms.map((p2) => p2.discount)
                  );
                    ...
                    Link,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.div,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-36 bg-muted/30 flex items-center justify-center p-3 overflow-hidden", children: [
                              simMaxDiscount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-2 z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-accent text-accent-foreground border-0 text-[9px] font-bold px-1.5 py-0.5", children: [
                                "-",
                                simMaxDiscount,
                                "%"
                              ] }) }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-xs text-foreground line-clamp-2 leading-snug mb-1 min-h-[2.5rem]", children: sim.title }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 mb-2", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsx(RatingStars, { rating: sim.averageRating, size: "sm" }),
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-accent text-base", children: [
                                  "$",
                                  simBest == null ? void 0 : simBest.price.toFixed(2)
                                ] }),
                                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: simBest == null ? void 0 : simBest.platform })
                              ] })
                            ] })
                          ]
                        }
